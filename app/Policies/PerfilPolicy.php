...
class PerfilPolicy
{
     ...
     * @return mixed
     */
    public function viewAny(User $user) // Para bloquear todo, se usa para apartados premiun
    {
        //
    }
     ...
     * @return mixed
     */
    public function view(User $user, Perfil $perfil) //Para bloquear ciertas vistas
    {
