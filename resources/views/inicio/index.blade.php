...
@section('content')
  ...
  {{--<img src="{{ url('images/myimg.jpeg') }}" alt="Imagen fondo">--}}
  {{--<img src="{{ asset('images/myimg.jpeg') }}" alt="Imagen fondo">--}}
  ...
  <div class="owl-carousel owl-theme">
    @foreach($nuevas as $nueva)
      <div class="card">
        <img src="/storage/{{$nueva->imagen}}" alt="imagen" class="card-img-top">
        <div class="card-body">
          <h3>{{ Str::title($nueva->titulo) }}</h3>
          <p>{{ Str::limit(strip_tags($nueva->preparacion),50) }}</p> {{-- Para que solo imprima las primeras 50 letras de la preparacion--}}
